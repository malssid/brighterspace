...
import { SmallCloseIcon, HamburgerIcon, SunIcon, MoonIcon } from "@chakra-ui/icons"
...
function HomeDashboard({active}) {
    ...
    return (
        <>
            ...
            <Group title="System">
                <Link icon={colorMode === "light" ? <SunIcon /> : <MoonIcon />} text={`Toggle ${colorMode === "light" ? "Dark" : "Light"}`} onClick={toggleColorMode}>
