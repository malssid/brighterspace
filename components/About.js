  ...
  return (
    <>
      ...
      >
        ...
        {process.env.NODE_ENV} {process.env.version} (Built{" "}
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Brighterspace {process.env.version} </ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            Brighterspace, a better <b>Learning</b> Management System <br />
            {process.env.NODE_ENV} {process.env.version} (Built{" "}
            {process.env.builddate})<br />
            &copy; Brighterspace 2021 <br />
            <br />
            <b>Contributors:</b> @malssid, @bendahrooge <br />
            <br />
