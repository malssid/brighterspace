...
import { HamburgerIcon, CloseIcon, SearchIcon, AttachmentIcon, ChatIcon } from "@chakra-ui/icons";
            ...
            >
                ...
                <About>
                    <UI.Text 
                        ...
                        {process.env.NODE_ENV} {process.env.appversion} (Built {process.env.builddate})
                    </UI.Text>
                </About>
