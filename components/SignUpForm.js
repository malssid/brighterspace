  ...
  return (
    <Center mt={12}>
      <Flex
        ...
        align="center"
      >
        <Heading size="2xl" fontSize="45px" mb={4}>Sign Up</Heading>
        ...
        <form method="post" action="/api/register">
            ...
            <Input mt={4} placeholder="First Name" name="First_name" type="text" />
            <Input mt={4} placeholder="Last Name" name="Last_name" type="text" />

            <Input my={4} placeholder="Password" name="Password" type="password" />
          <Center><Button bg="blue.800" color="blue.100" type="submit">Sign Up</Button></Center>
        </form>

        <Center mt={5}>
          <Text fontSize={14}>Already have a Brighterspace account? <Link href="/account/sign-up"><a>Sign In</a></Link>.</Text>
          </Center>
      </Flex>
    </Center>
  );
